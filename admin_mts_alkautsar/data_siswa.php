...
.dark .hapus:hover { background: #560a0a    ; }
/* TABLE */
body.dark table{
    background:#1e1e1e;
    color:white;
...
<tr>
    ...
    <td><?= $row['No_HP'] ?></td>
<td class="aksi">
    <a href="edit_datasiswa.php?id=<?= $row['Id'] ?>" class="btn edit">Edit</a>
    <a href="hapus_siswa.php?id=<?= $row['Id'] ?>" class="btn hapus" onclick="return confirm('Yakin hapus?')">Hapus</a>
</td>
</tr>
<?php } ?>
